...
import 'package:shopping_app_api_project_gsg/ui/pages/product-details.dart';
import 'package:shopping_app_api_project_gsg/ui/widgets/productWidgetS.dart';
              ...
              body: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      provider.selectedProduct==null ? Container():
                      Text(
                        provider.selectedProduct.category[0].toUpperCase() + provider.selectedProduct.category.substring(1),
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      print(provider.categoryProducts[index].id);
                                    ...
                                    child: Container(
                                      ...
                                      //   ],
                                      // ),
                                      child: ProductWidgetS(productResponse: provider.categoryProducts[index],),
                                    ),
                                  );
                                }),
                      ),
