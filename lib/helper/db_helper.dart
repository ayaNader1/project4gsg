...
//       db.execute(
//           '''CREATE TABLE Cart (id INTEGER PRIMARY KEY, title TEXT, price REAL,category TEXT,image TEXT)''');
//
//     db.execute(
//         '''CREATE TABLE Favourite (id INTEGER PRIMARY KEY, title TEXT, price REAL,category TEXT,image TEXT)''');
//   });
//     return database;
//   }
//
